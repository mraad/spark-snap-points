...
/**
  */
class SnapperMSpec extends FlatSpec with Matchers {
  ...
  it should "not snap -20,0" in {
    val snap = Snapper.snapM(poly, -20, 0, 10)
  ...
  it should "not snap 120,0" in {
    val snap = Snapper.snapM(poly, 120, 0, 10)
  ...
  it should "not snap 50,20" in {
    val snap = Snapper.snapM(poly, 50, 20, 10)
  ...
  it should "snap -5,-5" in {
    val snap = Snapper.snapM(poly, -5, -5, 10)
  ...
  it should "snap -5,0" in {
    val snap = Snapper.snapM(poly, -5, 0, 10)
  ...
  it should "snap 0,-5" in {
    val snap = Snapper.snapM(poly, 0, -5, 10)
  ...
  it should "snap 0,0" in {
    val snap = Snapper.snapM(poly, 0, 0, 10)
  ...
  it should "snap 95,-5" in {
    val snap = Snapper.snapM(poly, 95, -5, 10)
  ...
  it should "snap 95,0" in {
    val snap = Snapper.snapM(poly, 95, 0, 10)
  ...
  it should "snap 100,-5" in {
    val snap = Snapper.snapM(poly, 100, -5, 10)
  ...
  it should "snap 100,0" in {
    val snap = Snapper.snapM(poly, 100, 0, 10)
  ...
  it should "snap 105,-5" in {
    val snap = Snapper.snapM(poly, 105, -5, 10)
  ...
  it should "snap 105,0" in {
    val snap = Snapper.snapM(poly, 105, 0, 10)
  ...
  it should "snap to 10,1" in {
    ...
    for (t <- 0 to 100) {
      ...
      val snap = Snapper.snapM(poly, px, py, 2.0)
